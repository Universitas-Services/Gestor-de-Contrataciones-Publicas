...
import {
  actoresConcursoCerradoSchema,
  type ActoresConcursoCerradoFormValues,
...
export interface ActoresConcursoCerradoStepProps {
  initialValues?: ActoresConcursoCerradoFormValues | null;
  onBack: () => void;
  onNext: (data: ActoresConcursoCerradoFormValues) => void;
  readOnly?: boolean;
}

export function ActoresConcursoCerradoStep({
  initialValues = null,
  onBack,
  onNext,
  readOnly = false,
}: ActoresConcursoCerradoStepProps) {
  ...
  const form = useForm<ActoresConcursoCerradoFormValues>({
    resolver: zodResolver(actoresConcursoCerradoSchema),
    defaultValues: {
      ...
      fecEnvioInvitacionCc: initialValues?.fecEnvioInvitacionCc ?? "",
    },
  });
