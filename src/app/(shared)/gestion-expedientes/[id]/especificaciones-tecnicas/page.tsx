...
import { EspecificacionesTecnicasForm } from "@/components/features-components/GestionExpedientes/fase1/especificaciones-tecnicas/EspecificacionesTecnicasForm";
...
export default async function GestionEspecificacionesTecnicasPage({ params }: Props) {
