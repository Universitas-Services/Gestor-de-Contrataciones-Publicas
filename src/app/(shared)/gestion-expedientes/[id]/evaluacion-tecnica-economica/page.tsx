...
import { EvaluacionTecnicaEconomicaForm } from "@/components/features-components/GestionExpedientes/fase1/evaluacion-tecnica-economica/EvaluacionTecnicaEconomicaForm";
...
export default async function GestionEvaluacionTecnicaEconomicaPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto flex w-full min-w-0 max-w-full flex-col items-start p-0">
      <EvaluacionTecnicaEconomicaForm
        expedienteId={id}
