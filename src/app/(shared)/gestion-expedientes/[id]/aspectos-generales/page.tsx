...
import { AspectosGeneralesForm } from "@/components/features-components/GestionExpedientes/fase1/aspectos-generales/AspectosGeneralesForm";
...
export default async function GestionAspectosGeneralesPage({ params }: Props) {
