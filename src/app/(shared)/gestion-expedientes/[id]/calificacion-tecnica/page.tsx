...
import { CalificacionTecnicaForm } from "@/components/features-components/GestionExpedientes/fase1/calificacion-tecnica/CalificacionTecnicaForm";
...
export default async function GestionCalificacionTecnicaPage({ params }: Props) {
