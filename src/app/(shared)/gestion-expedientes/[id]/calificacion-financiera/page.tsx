...
import { CalificacionFinancieraForm } from "@/components/features-components/GestionExpedientes/fase1/calificacion-financiera/CalificacionFinancieraForm";
...
export default async function GestionCalificacionFinancieraPage({ params }: Props) {
