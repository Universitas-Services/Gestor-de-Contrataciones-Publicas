...
import { ModeloContratoForm } from "@/components/features-components/GestionExpedientes/fase1/modelo-contrato/ModeloContratoForm";
...
export default async function GestionModeloContratoPage({ params }: Props) {
